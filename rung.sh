...
ppas=( 
       ...
       ppa:ytvwld/syncthing                     ppa:paolorotolo/copy
     )
...
cd ~/Downloads 
sleep 2
echo No Machine Installation
sleep 2
wget -O nomachine.deb http://download.nomachine.com/download/4.5/Linux/nomachine_4.5.0_1_amd64.deb
sudo dpkg -i nomachine.deb
sleep 2
echo Attempting Tomb Installation
sleep 2
cd ~/Downloads
